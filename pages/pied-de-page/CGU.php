<?php
    require($_SERVER['DOCUMENT_ROOT'] . "/global/global.php");
    InclusionFichier::debut("Conditions Générales d'utilisation");
?>

<div class="container">
    <h3>CONDITIONS GÉNÉRALES D'UTILISATION DU SITE
        <span class="txt_modifiable">[URL]</span>
    </h3><br><br>
    ...
    <p>
        ...
        disposition des services du site <span class="txt_modifiable">CY-GAME</span>
    ...
    <ul>
        ...
        <li>
            <p><span class="txt_modifiable">CY-GAME</span> se réserve le droit de modifier unilatéralement et
    ...
    <p>
        L'édition du site <span class="txt_modifiable">CY-GAME</span> est
        assurée par la Société <span class="txt_modifiable">Turki-Corpo</span>
         au capital de
        <span class="txt_modifiable">1 000 000</span>&nbsp;€ dont le
        siège social est situé au <span class="txt_modifiable">2 rue Paul Vaillant Couturier</span>.
    </p>
    <p>
        <span class="txt_modifiable">Le Directeur</span> de la
        publication est <span class="txt_modifiable">Monsieur</span> <span class="txt_modifiable">Turki Ilyas</span>.
    </p>
    <p>
        Éventuellement&nbsp;:</p>
    <ul>
        <li>
            <p>
                <span class="txt_modifiable">La Turki-Corpo</span> est une société
                du groupe <span class="txt_modifiable">Turki-Corpo Privacy</span> au capital de <span class="txt_modifiable">1 000 000</span>&nbsp;€ dont le siège social est situé au
                <span class="txt_modifiable">2 rue Paul Vaillant Couturier</span>.
            </p>
        </li>
    </ul>
    <p>
        L'hébergeur du site <span class="txt_modifiable">CY-GAME</span> est
        la Société <span class="txt_modifiable">Turki-Corpo Privacy</span> au capital de <span class="txt_modifiable">1 000 000</span>&nbsp;€ dont le siège social est situé au
        <span class="txt_modifiable">2 rue Paul Vaillant Couturier</span>.
    </p>
    <p class="h4">ARTICLE&nbsp;3&nbsp;:
        Définitions</p>
    <p>
    ...
    <ul>
        ...
        <li>
            <p>Membre&nbsp;:
                l'Utilisateur devient membre lorsqu'il est identifié sur le site.</p>
        </li>
        <li>
            <p>Identifiant
    ...
    <ul>
        <li>
            <p>
                <span class="txt_modifiable">articles d'information</span>&nbsp;
            </p>
        </li>
        <li>
            <p><span class="txt_modifiable">annonces
                    classées</span>&nbsp;</p>
        </li>
        <li>
            <p><span class="txt_modifiable">mise
                    en relation de personnes</span>&nbsp;</p>
        </li>
        <li>
            <p><span class="txt_modifiable">publication
                    de commentaires et d'œuvres personnelles</span>&nbsp;</p>
        </li>
    ...
    <p>
        ...
        pas la responsabilité de <span class="txt_modifiable">CY-GAME</span>.</p>
    <p>
    ...
    <p>
        ...
        électronique à l'adresse <span class="txt_modifiable">contact@cygame.com</span>.
    </p>
    <p class="h4">ARTICLE&nbsp;5&nbsp;:
    ...
    <p>
        ...
        l'informatique, aux fichiers et aux libertés. Le site est déclaré
        à la CNIL sous le numéro <span class="txt_modifiable">07.69.18.39.33</span>.</p>
    <p>
        En vertu des articles 48 et suivants de la loi n° 78-17 relative à l'informatique, 
        aux fichiers et aux libertés en date du 6&nbsp;janvier 1978, réécrite par l'ordonnance 
        n° 2018-1125 du 12 décembre 2018 applicable au 1er juin 2019,
    ...
    <ul>
        ...
        <li>
            <p>par mail à
                <span class="txt_modifiable">contact@cygame.com</span>&nbsp;;
            </p>
        </li>
        <li>
            <p>par voie
                postale au <span class="txt_modifiable">2 rue Paul Vaillant Couturier</span>.</p>
        </li>
    </ul>
    <p class="h4">ARTICLE&nbsp;7&nbsp;:
    ...
    <p>
        ...
        responsabilité de <span class="txt_modifiable">CY-GAME</span> qui n'a
    ...
    <p>
        ...
        seuls les tribunaux <span class="txt_modifiable">du ressort de la Cour
            d'appel de la ville de Cergy</span>
        sont compétents.</p>
    
    <p class="h4">ARTICLE&nbsp;12&nbsp;:
        Publication par l'Utilisateur</p>
    <p>
        Le site permet aux membres de publier <span class="txt_modifiable">des
            commentaires et des œuvres personnelles</span>.</p>
    <p>
        Dans ses publications, le membre s'engage à respecter les règles
        de la Netiquette et les règles de droit en vigueur.</p>
    <p>
        Le site exerce une modération <span class="txt_modifiable">a priori</span> sur les publications et se réserve le droit de
    ...
    <p>
        ...
        site, il cède à la société éditrice le droit non exclusif et
    ...
    <p>
        ...
        proximité de chaque utilisation de sa publication.</p>
</div>
